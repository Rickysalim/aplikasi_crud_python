...
--
-- Host: localhost    Database: magang
-- ------------------------------------------------------
...
CREATE TABLE `record_data` (
  ...
  `nama_PIC_perusahaan` varchar(100) DEFAULT NULL,
...
INSERT INTO `record_data` VALUES (1,'Ricky Salim','TI','Cengkareng','PT maju mundur','Hansen','Semanan');
...
-- Dump completed on 2023-01-19  0:41:11
